 ...
 */
@Component
public class SystemAvailableTimeZoneRepositoryDataSource implements SystemAvailableTimeZoneRepository {

	private final SystemAvailableTimeZoneEntityDao systemAvailableTimeZoneEntityDao;

	// コンストラクタ
	public SystemAvailableTimeZoneRepositoryDataSource(SystemAvailableTimeZoneEntityDao systemAvailableTimeZoneEntityDao) {
	 ...
	 */
	@Override
	public SystemAvailableTimeZone findOneBy(SystemAvailableTimeZoneCriteria systemAvailableTimeZoneCriteria) {
		SystemAvailableTimeZoneEntity systemAvailableTimeZoneEntity = systemAvailableTimeZoneEntityDao.findOneBy(systemAvailableTimeZoneCriteria);
