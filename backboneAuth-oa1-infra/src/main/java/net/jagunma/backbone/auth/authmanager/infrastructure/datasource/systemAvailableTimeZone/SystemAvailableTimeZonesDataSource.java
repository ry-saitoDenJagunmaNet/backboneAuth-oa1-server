 ...
 */
@Component
public class SystemAvailableTimeZonesDataSource implements SystemAvailableTimeZonesRepository {

    private final SystemAvailableTimeZoneEntityDao systemAvailableTimeZoneEntityDao;
    private final Orders defaultOrders = Orders.empty().addOrder("subSystemCode")
        .addOrder("dayOfWeek");

    // コンストラクタ
    SystemAvailableTimeZonesDataSource(
     ...
     */
    @Override
    public SystemAvailableTimeZones selectBy(
        SystemAvailableTimeZoneCriteria systemAvailableTimeZoneCriteria, Orders orders) {
        List<SystemAvailableTimeZoneEntity> list = systemAvailableTimeZoneEntityDao
            .findBy(systemAvailableTimeZoneCriteria, orders);
    ...
    public SystemAvailableTimeZones selectAll(Orders orders) {
        return SystemAvailableTimeZones
            .createFrom(systemAvailableTimeZoneEntityDao.findAll(orders));
    }
