 ...
 */
@Component
public class OperatorHistoriesDataSource implements OperatorHistoriesRepository {
    ...
    // コンストラクタ
    OperatorHistoriesDataSource(OperatorHistoryEntityDao operatorHistoryEntityDao) {
    ...
    public OperatorHistories selectBy(OperatorHistoryCriteria operatorHistoryCriteria,
        Orders orders) {
        List<OperatorHistoryEntity> list = operatorHistoryEntityDao
            .findBy(operatorHistoryCriteria, orders);
