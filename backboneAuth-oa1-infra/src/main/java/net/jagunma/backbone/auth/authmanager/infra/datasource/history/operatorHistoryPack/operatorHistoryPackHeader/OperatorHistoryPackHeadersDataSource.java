package net.jagunma.backbone.auth.authmanager.infra.datasource.history.operatorHistoryPack.operatorHistoryPackHeader;
...
import net.jagunma.backbone.auth.authmanager.application.model.domain.history.operatorHistoryPack.operatorHistoryPackHeader.OperatorHistoryPackHeaders;
import net.jagunma.backbone.auth.authmanager.application.model.domain.history.operatorHistoryPack.operatorHistoryPackHeader.OperatorHistoryPackHeadersRepository;
 ...
 */
@Component
public class OperatorHistoryPackHeadersDataSource implements OperatorHistoryPackHeadersRepository {
    ...
    // コンストラクタ
    OperatorHistoryPackHeadersDataSource(
     ...
     */
    @Override
    public OperatorHistoryPackHeaders selectBy(
        OperatorHistoryPackHeaderCriteria operatorHistoryPackHeaderCriteria, Orders orders) {
        List<OperatorHistoryPackHeaderEntity> list = operatorHistoryPackHeaderEntityDao
            .findBy(operatorHistoryPackHeaderCriteria, orders);
    ...
    public OperatorHistoryPackHeaders selectAll(Orders orders) {
        return OperatorHistoryPackHeaders
            .createFrom(operatorHistoryPackHeaderEntityDao.findAll(orders));
    }
