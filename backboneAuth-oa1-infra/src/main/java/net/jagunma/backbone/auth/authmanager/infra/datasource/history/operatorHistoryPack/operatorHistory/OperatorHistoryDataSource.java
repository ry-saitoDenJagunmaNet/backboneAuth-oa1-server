package net.jagunma.backbone.auth.authmanager.infra.datasource.history.operatorHistoryPack.operatorHistory;
 ...
 */
@Component
public class OperatorHistoryDataSource implements OperatorHistoryRepository {

    private final OperatorHistoryEntityDao operatorHistoryEntityDao;

    // コンストラクタ
    public OperatorHistoryDataSource(OperatorHistoryEntityDao operatorHistoryEntityDao) {
    ...
    public OperatorHistory findOneBy(OperatorHistoryCriteria operatorHistoryCriteria) {
        OperatorHistoryEntity operatorHistoryEntity = operatorHistoryEntityDao
            .findOneBy(operatorHistoryCriteria);
