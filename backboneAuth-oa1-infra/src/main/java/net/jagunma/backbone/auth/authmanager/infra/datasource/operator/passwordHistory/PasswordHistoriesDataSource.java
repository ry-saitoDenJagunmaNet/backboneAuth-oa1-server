package net.jagunma.backbone.auth.authmanager.infra.datasource.operator.passwordHistory;

import java.util.List;
import net.jagunma.backbone.auth.authmanager.model.domain.operator.passwordHistory.PasswordHistories;
import net.jagunma.backbone.auth.authmanager.model.domain.operator.passwordHistory.PasswordHistoriesRepository;
import net.jagunma.backbone.auth.authmanager.model.domain.operator.passwordHistory.PasswordHistoryCriteria;
...
public class PasswordHistoriesDataSource implements PasswordHistoriesRepository {
    ...
    public PasswordHistories selectBy(PasswordHistoryCriteria passwordHistoryCriteria,
        Orders orders) {
        List<PasswordHistoryEntity> list = passwordHistoryEntityDao
            .findBy(passwordHistoryCriteria, orders);
