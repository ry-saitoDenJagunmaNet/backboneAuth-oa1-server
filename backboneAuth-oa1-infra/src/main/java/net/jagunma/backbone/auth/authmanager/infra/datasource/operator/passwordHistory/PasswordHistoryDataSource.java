...
import net.jagunma.backbone.auth.authmanager.model.domain.operator.passwordHistory.PasswordHistory;
import net.jagunma.backbone.auth.authmanager.model.domain.operator.passwordHistory.PasswordHistoryCriteria;
import net.jagunma.backbone.auth.authmanager.model.domain.operator.passwordHistory.PasswordHistoryRepository;
