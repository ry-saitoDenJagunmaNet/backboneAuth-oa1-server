package net.jagunma.backbone.auth.authmanager.infrastructure.datasource.signTrace.signInTrace;

import java.util.List;
import net.jagunma.backbone.auth.authmanager.application.model.domain.signTrace.signInTrace.SignInTraceCriteria;
import net.jagunma.backbone.auth.authmanager.application.model.domain.signTrace.signInTrace.SignInTraces;
import net.jagunma.backbone.auth.authmanager.application.model.domain.signTrace.signInTrace.SignInTracesRepository;
 ...
 */
@Component
public class SignInTracesRepositoryDataSource implements SignInTracesRepository {

	private final SignInTraceEntityDao signInTraceEntityDao;
	private final Orders defaultOrders = Orders.empty().addOrder("tryDateTime").addOrder("tryIpAddress").addOrder("operatorCode");

	// コンストラクタ
	SignInTracesRepositoryDataSource(SignInTraceEntityDao signInTraceEntityDao) {
