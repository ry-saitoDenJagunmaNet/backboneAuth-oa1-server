 ...
 */
@Component
public class SuspendBizTranRepositoryDataSource implements SuspendBizTranRepository {

	private final SuspendBizTranEntityDao suspendBizTranEntityDao;

	// コンストラクタ
	public SuspendBizTranRepositoryDataSource(SuspendBizTranEntityDao suspendBizTranEntityDao) {
	...
	public SuspendBizTran findOneBy(SuspendBizTranCriteria suspendBizTranCriteria) {
		SuspendBizTranEntity suspendBizTranEntity = suspendBizTranEntityDao.findOneBy(suspendBizTranCriteria);
