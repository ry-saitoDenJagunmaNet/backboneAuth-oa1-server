 ...
 */
@Component
public class SignInTraceRepositoryDataSource implements SignInTraceRepository {

	private final SignInTraceEntityDao signInTraceEntityDao;

	// コンストラクタ
	public SignInTraceRepositoryDataSource(SignInTraceEntityDao signInTraceEntityDao) {
