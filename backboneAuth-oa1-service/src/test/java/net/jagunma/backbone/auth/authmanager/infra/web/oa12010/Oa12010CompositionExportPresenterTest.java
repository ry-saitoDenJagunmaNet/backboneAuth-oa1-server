...
class Oa12010CompositionExportPresenterTest {
    ...
    private BizTranGrp_BizTransSheet createBizTranGrp_BizTransSheet() {
        ...
        list.add(BizTranGrp_BizTranSheet.createFrom(1,"販売・畜産","ANTG01","データ入力取引グループ","AN0001","畜産メインメニュー",false,
    ...
    /**
     * {@link Oa12010CompositionExportPresenter#converterTo()}のテスト
     *  ●パターン
     *    通常
     *
     *  ●検証事項
    ...
    void bindTo_test0() {
        ...
        Oa12010CompositionExportPresenter presenter = new Oa12010CompositionExportPresenter();
        ...
        // 期待値
        Oa12010CompositionExcelWriteConverter expectedConverter = Oa12010CompositionExcelWriteConverter.with(
            createBizTranRole_BizTranGrpsSheet(),
            createBizTranGrp_BizTransSheet());

        // 実行
        Oa12010CompositionExcelWriteConverter actualConverter = presenter.converterTo();
