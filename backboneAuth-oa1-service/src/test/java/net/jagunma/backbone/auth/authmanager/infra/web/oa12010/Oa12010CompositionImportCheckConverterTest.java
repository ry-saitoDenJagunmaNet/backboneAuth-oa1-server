...
class Oa12010CompositionImportCheckConverterTest {
    ...
    private BizTranGrp_BizTransSheet createBizTranGrp_BizTransSheet() {
        ...
        list.add(BizTranGrp_BizTranSheet.createFrom(1,SubSystem.販売_畜産.getDisplayName(),"ANTG01","データ入力取引グループ","AN0001","畜産メインメニュー",false,
    ...
    /**
     * {@link Oa12010CompositionImportCheckConverter#with(String,BizTranRole_BizTranGrpsSheet,BizTranGrp_BizTransSheet)}テスト
     *  ●パターン
     *    通常
     *
     *  ●検証事項
    ...
    void with_test0() {
        ...
        // 実行
        Oa12010CompositionImportCheckConverter converter = Oa12010CompositionImportCheckConverter.with(
            subSystemCode,
            bizTranRole_BizTranGrpsSheet,
            bizTranGrp_BizTransSheet);

        // 結果検証
        assertTrue(converter instanceof Oa12010CompositionImportCheckConverter);
