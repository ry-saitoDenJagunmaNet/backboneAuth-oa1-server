...
class Oa11010SearchConverter implements OperatorSearchRequest {
    ...
    public List<TempoReferenceDto> getTempoList() {
        return arg.getTempoReferenceDtoList();
    }
    ...
    public Short getAvailableStatus0() {
        return arg.getAvailableStatus0();
    }
    ...
    public Short getAvailableStatus1() {
        return arg.getAvailableStatus1();
    }
    ...
    public Integer getExpirationSelect() {
        return arg.getExpirationSelect();
    }
    ...
    public LocalDate getExpirationStatusDate() {
        return arg.getExpirationStatusDate();
    }
    ...
    public LocalDate getExpirationStartDateFrom() {
        return arg.getExpirationStartDateFrom();
    }
    ...
    public LocalDate getExpirationStartDateTo() {
        return arg.getExpirationStartDateTo();
    }
    ...
    public LocalDate getExpirationEndDateFrom() {
        return arg.getExpirationEndDateFrom();
    }
    ...
    public LocalDate getExpirationEndDateTo() {
        return arg.getExpirationEndDateTo();
    }
    ...
    public Integer getSubSystemRoleConditionsSelect() {
        return arg.getSubSystemRoleConditionsSelect();
    }
    ...
    public Integer getBizTranRoleConditionsSelect() {
        return arg.getBizTranRoleConditionsSelect();
    }
    ...
    public String getBizTranRoleSubSyStemCode() {
        return arg.getBizTranRoleSubSystemCode();
    }
    ...
    public LocalDate getAccountLockOccurredDateFrom() {
        return arg.getAccountLockOccurredDateFrom();
    }
    ...
    public LocalDate getAccountLockOccurredDateTo() {
        return arg.getAccountLockOccurredDateTo();
    }
    ...
    public Short getAccountLockStatusLock() {
        return arg.getAccountLockStatusLock();
    }
    ...
    public Short getAccountLockStatusUnlock() {
        return arg.getAccountLockStatusUnlock();
    }
    ...
    public Short getPasswordHistoryCheck() {
        return arg.getPasswordHistoryCheck();
    }
    ...
    public Integer getPasswordHistoryLastChangeDate() {
        return arg.getPasswordHistoryLastChangeDate();
    }
    ...
    public String getPasswordHistoryLastChangeDateStatus() {
        return arg.getPasswordHistoryLastChangeDateStatus();
    }
    ...
    public Short getPasswordHistoryChangeType0() {
        return arg.getPasswordHistoryChangeType0();
    }
    ...
    public Short getPasswordHistoryChangeType1() {
        return arg.getPasswordHistoryChangeType1();
    }
    ...
    public Short getPasswordHistoryChangeType2() {
        return arg.getPasswordHistoryChangeType2();
    }
    ...
    public Short getPasswordHistoryChangeType3() {
        return arg.getPasswordHistoryChangeType3();
    }
    ...
    public LocalDate getSignintraceTrydateFrom() {
        return arg.getSignintraceTrydateFrom();
    }
    ...
    public LocalDate getSignintraceTrydateTo() {
        return arg.getSignintraceTrydateTo();
    }
    ...
    public String getSignintraceTryIpAddress() {
        return arg.getSignintraceTryIpAddress();
    }
    ...
    public Short getSignintraceSignIn() {
        return arg.getSignintraceSignIn();
    }
    ...
    public Short getSignintraceSignOut() {
        return arg.getSignintraceSignOut();
    }
    ...
    public Short[] getSignintraceSignInResult() {
        return arg.getSignintraceSignInResult();
    }
    ...
    public OperatorEntityCriteria genOperatorEntityCriteria() {
        ...
        if (!nvl(arg.getDeviceAuthUse(), (short) 0)
            .equals(nvl(arg.getDeviceAuthUnuse(), (short) 0))) {
