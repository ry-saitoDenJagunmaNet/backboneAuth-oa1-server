...
public class Oa11010SearchPresenter implements OperatorSearchResponse {
     ...
     */
    public void setOperatorReferenceDtos(List<OperatorReferenceDto> operatorReferenceDtos) {
        this.OperatorReferenceDtos = operatorReferenceDtos;
    }
...
//    }
    ...
    public void genPaginationHtml(int pageNo) {
        ...
        if (pageNo == 1) {
            ...
            html.append(
                "<li class=\"waves-effect\" th:remove=\"all\"><a href=\"#!\" onclick=\"oaex_th_searchBtn_onClick(")
                .append(pageNo - 1).append(");\">&lt;</a></li>");
        }
        for (int i = 1; i <= maxPageNo; i++) {
            if (pageNo == i) {
                html.append("<li class=\"active\" th:remove=\"all\"><a href=\"#!\">").append(i)
                    .append("</a></li>");
            } else {
                html.append(
                    "<li class=\"waves-effect\" th:remove=\"all\"><a href=\"#!\" onclick=\"oaex_th_searchBtn_onClick(")
