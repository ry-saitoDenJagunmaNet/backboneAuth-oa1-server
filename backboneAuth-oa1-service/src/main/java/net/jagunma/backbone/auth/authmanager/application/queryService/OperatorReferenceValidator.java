...
//            if (request.getExpirationStartDateFrom() != null &&
//                request.getExpirationStartDateTo() != null) {
//                if (request.getExpirationStartDateFrom()
//                    .compareTo(request.getExpirationStartDateTo()) > 0) {
//                    throw new GunmaRuntimeException("EOA10003", "有効期限開始の条件指定");
//                }
//            }
//            if (request.getExpirationEndDateFrom() != null &&
//                request.getExpirationStartDateTo() != null) {
//                if (request.getExpirationEndDateFrom().compareTo(request.getExpirationStartDateTo())
//                    > 0) {
...
//                        () -> new GunmaRuntimeException("EOA10002",
//                            "サブシステムロール " + a.getSubSystemRoleCode() + "の状態指定日"));
//                }
//
...
//                        throw new GunmaRuntimeException("EOA10002",
//                            "サブシステムロール " + a.getSubSystemRoleCode() + "の条件指定");
//                    }
//                    if (a.getExpirationStartDateFrom() != null &&
//                        a.getExpirationStartDateTo() != null) {
//                        if (a.getExpirationStartDateFrom().compareTo(a.getExpirationStartDateTo())
//                            > 0) {
...
//                        a.getExpirationEndDateTo() != null) {
//                        if (a.getExpirationEndDateFrom().compareTo(a.getExpirationEndDateTo())
//                            > 0) {
//                            throw new GunmaRuntimeException("EOA10003",
//                                "サブシステムロール " + a.getSubSystemRoleCode() + "の条件指定");
//                        }
...
//                    Preconditions.checkNotNull(a.getExpirationStatusDate(),
//                        () -> new GunmaRuntimeException("EOA10002",
//                            "取引ロール " + a.getBizTranRoleCode() + "の状態指定日"));
//                }
//
//                if (ConditionsExpirationSelect.条件指定.getCode().equals(a.getExpirationSelect())) {
//                    if (a.getExpirationStartDateFrom() == null &&
...
//                        a.getExpirationStartDateTo() == null) {
//                        throw new GunmaRuntimeException("EOA10002",
//                            "取引ロール " + a.getBizTranRoleCode() + "の条件指定");
//                    }
//                    if (a.getExpirationStartDateFrom() != null &&
//                        a.getExpirationStartDateTo() != null) {
//                        if (a.getExpirationStartDateFrom().compareTo(a.getExpirationStartDateTo())
...
//            if (request.getSignintraceTrydateFrom().compareTo(request.getSignintraceTrydateTo())
//                > 0) {
