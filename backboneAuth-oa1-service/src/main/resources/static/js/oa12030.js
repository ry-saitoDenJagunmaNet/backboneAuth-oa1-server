 ...
 * 閉じるボタンクリックイベントです。
 */
function oaex_th_closeBtn_onClick() {
	location.href = "../oa12020/backSearch";
}
...
function oaex_th_deleteBtn_onClick() {
...
function oaex_initialize() {
	...
	// 取引グループ、取引のテーブルをクリア（ほんとはサブシステムが選択されていないと取引グループのテーブルは設定されない）
