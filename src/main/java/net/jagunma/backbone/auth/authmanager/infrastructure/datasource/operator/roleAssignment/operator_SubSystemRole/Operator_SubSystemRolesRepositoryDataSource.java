package net.jagunma.backbone.auth.authmanager.infrastructure.datasource.operator.roleAssignment.operator_SubSystemRole;
...
import net.jagunma.backbone.auth.authmanager.application.model.domain.operator.roleAssignment.operator_SubSystemRole.Operator_SubSystemRoles;
import net.jagunma.backbone.auth.authmanager.application.model.domain.operator.roleAssignment.operator_SubSystemRole.Operator_SubSystemRolesRepository;
