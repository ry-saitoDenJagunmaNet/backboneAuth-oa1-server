...
import net.jagunma.backbone.auth.authmanager.application.model.domain.operator.operatorHistoryPack.operatorHistoryPackHeader.OperatorHistoryPackHeader;
...
import net.jagunma.backbone.auth.authmanager.application.model.domain.operator.operatorHistoryPack.operatorHistoryPackHeader.OperatorHistoryPackHeaderRepository;
 ...
 */
@Component
public class OperatorHistoryPackHeaderRepositoryDataSource implements OperatorHistoryPackHeaderRepository {

	private final OperatorHistoryPackHeaderEntityDao operatorHistoryPackHeaderEntityDao;

	// コンストラクタ
	public OperatorHistoryPackHeaderRepositoryDataSource(OperatorHistoryPackHeaderEntityDao operatorHistoryPackHeaderEntityDao) {
	 ...
	 */
	@Override
	public OperatorHistoryPackHeader findOneBy(OperatorHistoryPackHeaderCriteria operatorHistoryPackHeaderCriteria) {
		OperatorHistoryPackHeaderEntity operatorHistoryPackHeaderEntity = operatorHistoryPackHeaderEntityDao.findOneBy(operatorHistoryPackHeaderCriteria);
