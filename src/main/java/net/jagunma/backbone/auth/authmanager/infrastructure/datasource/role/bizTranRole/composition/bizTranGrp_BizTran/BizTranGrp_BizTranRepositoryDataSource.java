 ...
 */
@Component
public class BizTranGrp_BizTranRepositoryDataSource implements BizTranGrp_BizTranRepository {

	private final BizTranGrp_BizTranEntityDao bizTranGrp_BizTranEntityDao;

	// コンストラクタ
	public BizTranGrp_BizTranRepositoryDataSource(BizTranGrp_BizTranEntityDao bizTranGrp_BizTranEntityDao) {
	...
	public BizTranGrp_BizTran findOneBy(BizTranGrp_BizTranCriteria bizTranGrp_BizTranCriteria) {
		BizTranGrp_BizTranEntity bizTranGrp_BizTranEntity = bizTranGrp_BizTranEntityDao.findOneBy(bizTranGrp_BizTranCriteria);
