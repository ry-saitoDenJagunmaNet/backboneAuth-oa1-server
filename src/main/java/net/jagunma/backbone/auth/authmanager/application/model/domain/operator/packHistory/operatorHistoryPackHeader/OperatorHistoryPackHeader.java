package net.jagunma.backbone.auth.authmanager.application.model.domain.operator.packHistory.operatorHistoryPackHeader;
...
public class OperatorHistoryPackHeader {
	 ...
	 */
	public OperatorHistoryPackHeaderEntity getOperatorHistoryEntityForRepository() {
