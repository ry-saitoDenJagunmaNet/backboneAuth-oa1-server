package net.jagunma.backbone.auth.authmanager.application.model.domain.operator.accountLock;
...
public class AccountLock {
	...
	private AccountLockEntity accountLockEntity;
	 ...
	 */
	public AccountLockEntity getOperatorHistoryEntityForRepository() {
