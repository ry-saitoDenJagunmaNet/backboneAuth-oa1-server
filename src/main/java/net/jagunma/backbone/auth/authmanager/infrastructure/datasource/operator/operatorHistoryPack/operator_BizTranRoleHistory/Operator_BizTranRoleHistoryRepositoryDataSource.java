...
import net.jagunma.backbone.auth.authmanager.application.model.domain.operator.operatorHistoryPack.operator_BizTranRoleHistory.Operator_BizTranRoleHistory;
...
import net.jagunma.backbone.auth.authmanager.application.model.domain.operator.operatorHistoryPack.operator_BizTranRoleHistory.Operator_BizTranRoleHistoryRepository;
 ...
 */
@Component
public class Operator_BizTranRoleHistoryRepositoryDataSource implements	Operator_BizTranRoleHistoryRepository {

	private final Operator_BizTranRoleHistoryEntityDao operator_BizTranRoleHistoryEntityDao;

	// コンストラクタ
	public Operator_BizTranRoleHistoryRepositoryDataSource(Operator_BizTranRoleHistoryEntityDao operator_BizTranRoleHistoryEntityDao) {
	 ...
	 */
	@Override
	public Operator_BizTranRoleHistory findOneBy(Operator_BizTranRoleHistoryCriteria operator_BizTranRoleHistoryCriteria) {
		Operator_BizTranRoleHistoryEntity operator_BizTranRoleHistoryEntity = operator_BizTranRoleHistoryEntityDao.findOneBy(operator_BizTranRoleHistoryCriteria);
