...
import net.jagunma.backbone.auth.authmanager.application.model.domain.operator.passwordHistory.PasswordHistories;
import net.jagunma.backbone.auth.authmanager.application.model.domain.operator.passwordHistory.PasswordHistoriesRepository;
