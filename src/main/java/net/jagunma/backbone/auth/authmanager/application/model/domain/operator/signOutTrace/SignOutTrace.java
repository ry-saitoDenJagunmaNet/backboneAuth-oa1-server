package net.jagunma.backbone.auth.authmanager.application.model.domain.operator.signOutTrace;
...
public class SignOutTrace {
	...
	private SignOutTraceEntity signOutTraceEntity;
	 ...
	 */
	public SignOutTraceEntity getOperatorHistoryEntityForRepository() {
