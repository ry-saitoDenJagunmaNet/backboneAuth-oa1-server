package net.jagunma.backbone.auth.authmanager.infrastructure.datasource.role.bizTranRole.composition.bizTranRole_BizTranGrp;
 ...
 */
@Component
public class BizTranRole_BizTranGrpsRepositoryDataSource implements BizTranRole_BizTranGrpsRepository {

	private final BizTranRole_BizTranGrpEntityDao bizTranRole_BizTranGrpEntityDao;
	private final Orders defaultOrders = Orders.empty().addOrder("bizTranRoleId").addOrder("bizTranGrpId");

	// コンストラクタ
	BizTranRole_BizTranGrpsRepositoryDataSource(BizTranRole_BizTranGrpEntityDao bizTranRole_BizTranGrpEntityDao) {
	...
	public BizTranRole_BizTranGrps selectBy(BizTranRole_BizTranGrpCriteria bizTranRole_BizTranGrpCriteria, Orders orders) {
		List<BizTranRole_BizTranGrpEntity> list = bizTranRole_BizTranGrpEntityDao.findBy(bizTranRole_BizTranGrpCriteria, orders);
	 ...
	 */
	@Override
	public BizTranRole_BizTranGrps selectBy(BizTranRole_BizTranGrpCriteria bizTranRole_BizTranGrpCriteria) {
