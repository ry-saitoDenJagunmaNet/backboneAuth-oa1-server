package net.jagunma.backbone.auth.authmanager.infrastructure.datasource.role.bizTranRole.composition.bizTranGrp_BizTran;
...
import net.jagunma.backbone.auth.authmanager.application.model.domain.role.bizTranRole.composition.bizTranGrp_BizTran.BizTranGrp_BizTrans;
import net.jagunma.backbone.auth.authmanager.application.model.domain.role.bizTranRole.composition.bizTranGrp_BizTran.BizTranGrp_BizTransRepository;
 ...
 */
@Component
public class BizTranGrp_BizTransRepositoryDataSource implements BizTranGrp_BizTransRepository {

	private final BizTranGrp_BizTranEntityDao bizTranGrp_BizTranEntityDao;
	private final Orders defaultOrders = Orders.empty().addOrder("bizTranGrpId").addOrder("bizTranId");

	// コンストラクタ
	BizTranGrp_BizTransRepositoryDataSource(BizTranGrp_BizTranEntityDao bizTranGrp_BizTranEntityDao) {
	...
	public BizTranGrp_BizTrans selectBy(BizTranGrp_BizTranCriteria bizTranGrp_BizTranCriteria, Orders orders) {
		List<BizTranGrp_BizTranEntity> list = bizTranGrp_BizTranEntityDao.findBy(bizTranGrp_BizTranCriteria, orders);
