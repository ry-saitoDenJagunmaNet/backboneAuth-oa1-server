package net.jagunma.backbone.auth.authmanager.infrastructure.datasource.operatorBizTranRole;
...
import net.jagunma.backbone.auth.authmanager.application.model.domain.operatorBizTranRole.Operator_BizTranRoleCriteria;
import net.jagunma.backbone.auth.authmanager.application.model.domain.operatorBizTranRole.Operator_BizTranRoleRepository;
