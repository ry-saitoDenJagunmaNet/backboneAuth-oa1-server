...
class Oa11010SearchConverter implements OperatorSearchRequest {
	...
	public List<Oa11010SearchRequestOperatorSubsystemRoleRequest> getSubsystemRoleList() {
		List<Oa11010SearchRequestOperatorSubsystemRoleRequest> list = newArrayList();
		arg.getSubsystemRoleList().forEach(s -> {
			Oa11010SearchRequestOperatorSubsystemRoleRequest os = new Oa11010SearchRequestOperatorSubsystemRoleRequest();
	...
	public List<Oa11010SearchRequestOperatorBiztranRole> getBiztranRoleList() {
		List<Oa11010SearchRequestOperatorBiztranRole> list = newArrayList();
		arg.getBiztranRoleList().forEach(b -> {
			Oa11010SearchRequestOperatorBiztranRole ob = new Oa11010SearchRequestOperatorBiztranRole();
