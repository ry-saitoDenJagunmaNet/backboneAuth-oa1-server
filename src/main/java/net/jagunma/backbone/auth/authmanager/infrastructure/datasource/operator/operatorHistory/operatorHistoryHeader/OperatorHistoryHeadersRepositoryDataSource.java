package net.jagunma.backbone.auth.authmanager.infrastructure.datasource.operator.operatorHistory.operatorHistoryHeader;

import java.util.List;
import net.jagunma.backbone.auth.authmanager.application.model.domain.operator.operatorHistory.operatorHistoryHeader.OperatorHistoryHeaderCriteria;
import net.jagunma.backbone.auth.authmanager.application.model.domain.operator.operatorHistory.operatorHistoryHeader.OperatorHistoryHeaders;
import net.jagunma.backbone.auth.authmanager.application.model.domain.operator.operatorHistory.operatorHistoryHeader.OperatorHistoryHeadersRepository;
 ...
 */
@Component
public class OperatorHistoryHeadersRepositoryDataSource implements
	...
	// コンストラクタ
	OperatorHistoryHeadersRepositoryDataSource(OperatorHistoryHeaderEntityDao operatorHistoryHeaderEntityDao) {
	...
	public OperatorHistoryHeaders selectBy(
		...
		List<OperatorHistoryHeaderEntity> list = operatorHistoryHeaderEntityDao.findBy(
			operatorHistoryHeaderCriteria, orders);
	...
	public OperatorHistoryHeaders selectAll(Orders orders) {
		return OperatorHistoryHeaders.createFrom(operatorHistoryHeaderEntityDao.findAll(orders));
	}
	/**
	 * オペレーター履歴ヘッダーの全件検索を行います。
	 *
