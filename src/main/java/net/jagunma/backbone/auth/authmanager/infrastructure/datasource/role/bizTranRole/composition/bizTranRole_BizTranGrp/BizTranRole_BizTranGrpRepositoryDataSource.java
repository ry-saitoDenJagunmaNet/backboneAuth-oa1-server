 ...
 */
@Component
public class BizTranRole_BizTranGrpRepositoryDataSource implements BizTranRole_BizTranGrpRepository {

	private final BizTranRole_BizTranGrpEntityDao bizTranRole_BizTranGrpEntityDao;

	// コンストラクタ
	public BizTranRole_BizTranGrpRepositoryDataSource(BizTranRole_BizTranGrpEntityDao bizTranRole_BizTranGrpEntityDao) {
	 ...
	 */
	@Override
	public BizTranRole_BizTranGrp findOneBy( BizTranRole_BizTranGrpCriteria bizTranRole_BizTranGrpCriteria) {
		BizTranRole_BizTranGrpEntity bizTranRole_BizTranGrpEntity = bizTranRole_BizTranGrpEntityDao.findOneBy(bizTranRole_BizTranGrpCriteria);
