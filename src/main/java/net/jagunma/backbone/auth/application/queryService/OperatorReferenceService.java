...
public class OperatorReferenceService {
	public OperatorReferenceService() {
	}

	public List<OperatorEntity> getOperatorList() {
		//TODO: オペレータ情報を読む
		...
		oplist.add(new Object[]{1, "OP101001", "前橋太郎", startdate, enddate, 6, "006", 1, "001", "本所", 1, 0, "2110", "業務統括者（販売・青果）", startdate, enddate, "YSAG20", "（青果）精算担当", startdate, enddate});
		oplist.add(new Object[]{1, "OP101001", "前橋太郎", startdate, enddate, 6, "006", 1, "001", "本所", 1, 0, "2110", "業務統括者（販売・青果）", startdate, enddate, "YSAG30", "（青果）集荷場担当", startdate, enddate});
		oplist.add(new Object[]{1, "OP101001", "前橋太郎", startdate, enddate, 6, "006", 1, "001", "本所", 1, 0, "2120", "業務統括者（販売・花卉）", startdate, enddate, "YFAG20", "（花卉）精算担当", startdate, enddate});
		oplist.add(new Object[]{1, "OP101001", "前橋太郎", startdate, enddate, 6, "006", 1, "001", "本所", 1, 0, "2120", "業務統括者（販売・青果）", startdate, enddate, "YFAG30", "（花卉）集荷場担当", startdate, enddate});
		oplist.add(new Object[]{2, "OP101002", "前橋次郎", startdate, enddate, 6, "006", 1, "001", "本所", 1, 1, "2120", "業務統括者（販売・花卉）", startdate, enddate, "YFAG20", "（花卉）精算担当", startdate, enddate});
		oplist.add(new Object[]{2, "OP101002", "前橋次郎", startdate, enddate, 6, "006", 1, "001", "本所", 1, 1, "2120", "業務統括者（販売・青果）", startdate, enddate, "YFAG30", "（花卉）集荷場担当", startdate, enddate});
		oplist.add(new Object[]{3, "OP101003", "前橋三郎", startdate, enddate, 6, "006", 1, "001", "本所", 0, 0, "2300", "業務統括者（販売・畜産）", startdate, enddate, "ANAG20", "（畜産）精算担当", startdate, enddate});
		...
		oplist.add(new Object[]{17, "OP101017", "前橋花七郎", startdate, enddate, 6, "006", 2, "002", "○○○支所", 0, 0, "2120", "業務統括者（販売・花卉）", startdate, enddate, "YFAG99", "（花卉）ＮＮＮ担当", startdate, enddate});
		oplist.add(new Object[]{17, "OP101017", "前橋花七郎", startdate, enddate, 6, "006", 2, "002", "○○○支所", 0, 0, "2120", "業務統括者（販売・花卉）", startdate, enddate, "YFAG99", "（花卉）ＮＮＮ担当", startdate, enddate});
		oplist.add(new Object[]{17, "OP101017", "前橋花七郎", startdate, enddate, 6, "006", 2, "002", "○○○支所", 0, 0, "2120", "業務統括者（販売・花卉）", startdate, enddate, "YFAG99", "（花卉）ＮＮＮ担当", startdate, enddate});
		oplist.add(new Object[]{17, "OP101017", "前橋花七郎", startdate, enddate, 6, "006", 2, "002", "○○○支所", 0, 0, "2120", "業務統括者（販売・花卉）", startdate, enddate, "YFAG99", "（花卉）ＮＮＮ担当", startdate, enddate});
